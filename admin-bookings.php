...
<head>
  ...
  <style>
    * {
    ...
    /* Special handling for revenue card with large numbers */
    .stat-card:nth-child(5) .number {
      font-size: 2rem; /* Slightly smaller for revenue */
    }
  ...
  <div class="admin-dashboard">
        <div class="sidebar">
            ...
            <nav>
                ...
                <a href="admin-bookings.php" class="active">
    ...
    <div class="main-content">
      ...
      <div class="bookings-table">
        ...
        <div class="bookings-grid" id="bookingsTable">
